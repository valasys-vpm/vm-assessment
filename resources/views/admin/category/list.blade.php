                                    ...
                                    <div class="card">
                                        <div class="card-header">
                                            ...
                                            <div class="float-right">
                                                <button type="button" class="btn btn-primary btn-square btn-sm" onclick="addCategory();"><i class="feather icon-plus"></i>New Category</button>
                                            </div>
                                        </div>
                                        <div class="card-block">
                                            <div class="table-responsive">
                                                <table id="table-categories" class="display table nowrap table-striped table-hover">
                                                    <thead>
                                                    <tr>
                                                        <th>Name</th>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title h4" id="modal-heading">Add new category</h5>
                    ...
                    <form id="modal-category-form">
                        ...
                        <div class="row">
                            <div class="col-md-12 form-group">
                                ...
                                <input type="text" class="form-control btn-square" id="name" name="name" placeholder="Enter category name" required>
                            </div>
                            <div class="col-md-12 form-group">
                                <label for="number_of_question">Number of question</label>
                                <input type="text" class="form-control btn-square" id="number_of_question" name="number_of_question" placeholder="Enter number of question" required>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-12 form-group">
...
@section('javascript')
    ...
    <script src="{{ asset('public/js/admin/category.js?='.time()) }}"></script>
@append
