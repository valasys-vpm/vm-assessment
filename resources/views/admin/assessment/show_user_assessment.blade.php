                            ...
                            <div class="row align-items-center">
                                <div class="col-md-12">
                                    ...
                                    <ul class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item"><a href="{{ route('admin.assessment.show', base64_encode($resultUserAssessment->assessment_id)) }}">Assessment Details</a></li>
                                        <li class="breadcrumb-item"><a href="javascript:void(0);">User's Result</a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="col-sm-12">
                                    <div class="card">
                                        ...
                                        <div class="card-block">
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <h6>User Name: </h6>{{ $resultUserAssessment->user->first_name. ' ' .$resultUserAssessment->user->last_name }}
                                                </div>
                                                <div class="col-md-4">
                                                    <h6>Employee Code: </h6>{{ $resultUserAssessment->user->employee_code }}
                                                </div>
                                                <div class="col-md-4">
                                                    <h6>Email: </h6>{{ $resultUserAssessment->user->email }}
                                                </div>
                                            </div>

                                            <div class="row pt-4">
                                                <div class="col-md-4">
                                                    <h6>Marks Obtained: </h6><h4>{{ $resultUserAssessment->marks_obtained }}</h4>
                                                </div>
                                                <div class="col-md-4">
                                                    <h6>Total Questions:</h6><h4>{{ $resultUserAssessment->assessment->number_of_questions }}</h4>
                                                </div>
                                                <div class="col-md-4">
                                                    <h6>EAttempted:</h6><h4>{{ $resultUserAssessment->attempted }}</h4>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
