...
Route::prefix('assessment')->name('assessment.')->group(function()
{
    ...
    Route::any('/send-assessment-result-bulk', [App\Http\Controllers\Admin\AssessmentController::class, 'sendAssessmentResultBulk'])->name('send_assessment_result_bulk');
    ...
    Route::any('/{id}/delete-user-assessment', [App\Http\Controllers\Admin\AssessmentController::class, 'deleteUserAssessment'])->name('delete_user_assessment');
});
