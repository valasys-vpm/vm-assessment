...
Route::middleware(['web', 'check.user'])->name('user.')->group(function (){
    ...
    Route::prefix('assessment')->name('assessment.')->group(function()
    {
        ...
        Route::any('/{id}/view-assessment', [App\Http\Controllers\User\AssessmentController::class, 'show'])->name('show');
...
// Change Password
Route::any('/update-password', [App\Http\Controllers\HomeController::class, 'updatePassword'])->name('update.password');
